...
makeTitle: routine [name [string!] txt [string!]][
	...
	cvZero as byte-ptr! image
	cvGetTextSize as c-string! string/rs-head txt font text_size as int-ptr! ymin
	cvPutText as byte-ptr! image as c-string! string/rs-head txt pt1/x pt1/y font 0.0 56.0 -56.0 0.0
	cvShowImage as c-string! string/rs-head name as byte-ptr! image
]
...
drawText: routine [
	...
	color: tocvRGB int-to-float r int-to-float g int-to-float b 0.0
    cvPutText as byte-ptr! image "Red is fantastic!" p1/x p1/y font color/v0 color/v1 color/v2 color/v3
    cvShowImage as c-string! string/rs-head name as byte-ptr! image
	cvWaitKey 1
]
...
drawLines: routine [
	...
	color: tocvRGB int-to-float r int-to-float g int-to-float b 0.0
	cvLine as byte-ptr! image p1/x p1/y p2/x p2/y color/v0 color/v1 color/v2 color/v3 t CV_AA 0
	cvShowImage as c-string! string/rs-head name as byte-ptr! image
	cvWaitKey 1
]
...
drawRectangles: routine [
	...
	color: tocvRGB int-to-float r int-to-float g int-to-float b 0.0
	cvRectangle as byte-ptr! image p1/x p1/y p2/x p2/y color/v0 color/v1 color/v2 color/v3 t CV_AA 0
	cvShowImage as c-string! string/rs-head name as byte-ptr! image
	cvWaitKey 1
]
...
drawCircles: routine [
	...
	color: tocvRGB int-to-float r int-to-float g int-to-float b 0.0
	cvCircle as byte-ptr! image p1/x p1/y rad color/v0 color/v1 color/v2 color/v3 t CV_AA 0
	cvShowImage as c-string! string/rs-head name as byte-ptr! image
	cvWaitKey 1
]
...
drawPolygons: routine [
	...
	contours: 2
	isClosed: 1 
	cvPolyLine as byte-ptr! image dppoints parray contours isClosed color/v0 color/v1 color/v2 color/v3 t CV_AA 0
	cvShowImage as c-string! string/rs-head name as byte-ptr! image
	free mem1
	free mem2
	cvWaitKey 1
...
drawConvexPoly: routine [
	...
	ppoints/12: p6/x
	color: tocvRGB int-to-float r int-to-float g int-to-float b 0.0
	cvFillConvexPoly as byte-ptr! image ppoints 6 color/v0 color/v1 color/v2 color/v3 CV_AA 0
	cvShowImage as c-string! string/rs-head name as byte-ptr! image
	free mem2
	cvWaitKey 1
]
