...
;#define objdetect "/usr/local/lib32/opencv3/libopencv_objdetect.dylib"
; OpenCV objdetect C Functions
#switch OS [
    MacOSX  [#define objdetect "/usr/local/lib32/opencv3/libopencv_world.3.0.0.dylib" #define importMode cdecl]
    Windows [#define objdetect "c:\opencv3\build\x86\vc12\bin\opencv_world300.dll" #define importMode cdecl] ;stdcall in case of
    Linux   [#define objdetect "/usr/local/lib32/opencv3/libopencv_world.so.3.0.0" #define importMode cdecl]
]
